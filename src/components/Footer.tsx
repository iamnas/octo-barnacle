...
function Footer() {
  ...
  className='w-full h-[110vh] p-[50px] mt-[10vh] flex bg-zinc-800 text-white'
>
    
        {/* <div id='footer' data-scroll data-scroll-section data-scroll-speed="-.05" className='w-full h-[110vh] p-[50px] mt-[10vh] flex bg-zinc-800'> */}
            <div className='relative w-1/2 h-full font-["grotesk"]'>
                <h1 className='uppercase text-[8.8vw] leading-none '>eye-</h1>
                <h1 className='uppercase text-[8.8vw] leading-16 '>opening</h1>
            ...
            <div className='relative w-1/2 h-full'>
                <h1 className='uppercase text-[8.8vw] leading-none font-[grotesk] flex flex-col'>presentations</h1>
                ...
                <div className='l flex flex-col'>
                    <div className='mt-10 mb-6'>L:</div>
                    {["202-1965 4th Ave", "Vancouver,Canada", "30 Chukarina St", "Lviv,Ukraine"].map((item, index) => {
                        return (<motion.div
                            key={index}
                            className={`${index === 2 && "mt-6"} relative w-fit cursor-pointer overflow-hidden`}
                            whileHover="hover"
                            initial="initial"
                            animate="initial"
                        >
                            <a href='' key={index} className="relative z-10">{item}</a>
                            <motion.div
                                className="absolute bottom-0 left-0 h-[1px] bg-white"
                                variants={{
                                    initial: { scaleX: 1, originX: 1 },
                ...
                <div className='e flex flex-col'>
                    <div className='mt-10 mb-6'>E:</div>
                    <motion.div
                        className="relative w-fit cursor-pointer overflow-hidden"
                        whileHover="hover"
                        initial="initial"
                ...
                <div className='absolute top-1/2 right-0'>
                    <div className='m flex flex-col pr-20'>
                        <div className='mt-10 mb-6'>M:</div>
                ...
                <div className='text-white/80 mt-10 flex justify-between'>
                    <div className='flex'>
                        <div>© ochi design 2025.</div>
                        <motion.div
                            className="relative w-fit cursor-pointer overflow-hidden"
                            whileHover="hover"
                            initial="initial"
                        ...
                        >
                            Legal Terms
                            <motion.div
                                className="absolute bottom-0 left-0 h-[1px] bg-zinc-600"
                                variants={{
                                    initial: { scaleX: 1, originX: 1 },
                                    hover: { scaleX: 0, originX: 1, transition: { duration: 0.3 } }
                                }}
